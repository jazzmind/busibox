...
ingestion status (including text + visual embeddings). Runs inside data-lxc and
uses the existing data API for processing.
"""
...
TEST_DOC_STATE_PATH = os.getenv("TEST_DOC_STATE_PATH", "/srv/data/test-docs-state.json")
