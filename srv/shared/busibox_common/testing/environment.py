...
Usage:
    # In conftest.py
    from busibox_common.testing.environment import load_env_files, set_auth_env, TEST_DOC_REPO_PATH
...
def load_env_files(service_dir: Optional[Path] = None) -> bool:
    ...
    Example:
        ...
        from busibox_common.testing.environment import load_env_files
